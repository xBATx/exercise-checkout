...
class PriceCalculationStrategySpec extends AnyFlatSpec with Matchers {
  "Default.getPrice" should "return correct price in several situations" in {
    Default(20).getPrice(1) shouldBe 20
    Default(0).getPrice(10) shouldBe 0
    Default(5).getPrice(4) shouldBe 20
  }
